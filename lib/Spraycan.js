...
Spraycan.prototype.prepareScreenshot = function() {
    ...
    if (window.streetView.currentPlace.hotspot) {
...
Spraycan.prototype.spray = function(x, y, distance, angle) {
    ...
    if (this.isClear() || (currentTime - this.timestamp > 500)) {
        ...
        for (var z = 0;
            ...
            this.drawContext.drawImage(this.brush, this.drawCanvas.width - _x, _y, this.defaultBrushSize, this.defaultBrushSize);
        }
        this.lastPoint = [x, y];
        this.timestamp = currentTime;
