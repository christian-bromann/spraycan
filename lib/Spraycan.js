function Spraycan(video,dataCanvas,drawCanvas) {
    ...
    window.addEventListener('click',   this.setup.bind(this), false);
...
Spraycan.prototype.setup = function(e) {

    // start application if startscreen is visible and video hasn't started yet
    if(this.video.paused) {
        // hide start screen, and remove node
        this.ui.startscreen.className += ' hide';
        window.setTimeout(function() {
            this.ui.startscreen.parentNode.removeChild(this.ui.startscreen);
        }.bind(this),500);
    ...
    // dont go into spraymode if click was just for focusing on map
