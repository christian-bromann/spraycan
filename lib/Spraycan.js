...
Spraycan.prototype.setPosition = function() {
    this.drawCanvas.setAttribute('data-lat',window.streetView.panorama.getPosition().Za);
    this.drawCanvas.setAttribute('data-lng',window.streetView.panorama.getPosition().$a);
};

Spraycan.prototype.setupCan = function() {
    if(this.isReady()) {
        this.setPosition();
    }
};