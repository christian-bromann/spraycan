...
Spraycan.prototype.findLightPoint = function(data) {
    ...
    return {
        x: x * (this.planeDimension ? (this.planeDimension.width / this.drawCanvas.width) : 1),
        y: y * (this.planeDimension ? (this.planeDimension.height / this.drawCanvas.height) : 1)
    };
};
...
Spraycan.prototype.getBrushSize = function(angle) {
    ...
    return size < this.defaultBrushSize ? this.defaultBrushSize : size > this.maxBrushSize ? this.maxBrushSize : size;
