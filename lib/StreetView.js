...
function StreetView(mapCanvas,lat,lng, heading) {
    ...
    this.places = {
        ...
        66: { name: 'Scheidemannstraße 1, Berlin',                   lat:  52.517766, lng:   13.376247, h: 343.32 },
        67: { name: 'Ehrenbergstraße 32, Berlin',                    lat:  52.447133, lng:   13.287908, h: 332.61 },
        68: { name: 'Dorotheenstraße 27, Berlin',                    lat:  52.519133, lng:   13.391911, h: 353.49 },
        69: { name: 'Nordufer 28, Berlin',                           lat:  52.539716, lng:   13.340476, h: 353.86 },
        70: { name: 'Weydingerstraße 2, Berlin',                     lat:  52.526091, lng:   13.411283, h: 288.83 },
        71: { name: 'Rosa-Luxemburg-Platz 3, Berlin',                lat:  52.526679, lng:   13.411384, h: 42.62  },
        72: { name: 'Charlottenstraße 85, Berlin',                   lat:  52.506469, lng:   13.392522, h: 79.83  },
        73: { name: 'Unter den Linden, Berlin',                      lat:  52.517179, lng:   13.393105, h: 297.35 },
...
StreetView.prototype.jump = function(placeID) {
    ...
    if(!place || window.spraycan.video.paused) {
        return;
    }
